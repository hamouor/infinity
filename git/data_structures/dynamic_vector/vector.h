...
* pushing and popping elements, accessing elements directly, and resizes itself
* on demand. The user can also reserve extra memory for the vector and shrink it
* to fit the current amount of elements.
* AUTHOR: HRD24
* REVIEWER:
* DATE: 07/04/2022
* VERSION: 0.1
...
/* TODO: Move the struct definition to the implementation file */
